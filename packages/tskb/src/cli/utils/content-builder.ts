...
\`InstanceType<MyClass>["methodName"]\` resolves to the actual method signature — the compiler validates the name exists and catches renames. This pattern works for **both public and private** TypeScript members.
